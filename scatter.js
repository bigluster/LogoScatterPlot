...
var viz = function($element, layout, _this) {
  ...
  var plot = svg.append("svg")
    ...
    plot.selectAll(".dot")
        ...
        .attr("width", layout.logoSize)
        .attr("height", layout.logoSize)
        .attr("xlink:href", function(d) {return d.dim(1).qText;})
        ...
        .on("mouseover", function(d){
          ...
          .on("mouseout", function(d){
            ...
            .append("title")
            .html(function(d) {
              var tempHtml=senseUtils.getDimLabel(1,layout) + ": " + d.dim(1).qText;
              for(i=1;i<=layout.qHyperCube.qMeasureInfo.length;i++) {
                console.log(i);
                console.log(d.measure(i));
                tempHtml += "<br/>" + senseUtils.getMeasureLabel(i,layout) + ": " + d.measure(i).qText;
              }
              return tempHtml;
            });
